<template>
  <div>
    ...
    <ul class="price-list">
      ...
      <li>Puude lõikamine/langetamine <strong>kokkuleppel</strong></li>
      <li>Võsalõikus <strong>kokkuleppel</strong></li>
      <li>Muud haljastustööd <strong>kokkuleppel</strong></li>
    </ul>
    <div class="two-col">
      <ContactForm />
      <NewsSidebar />
